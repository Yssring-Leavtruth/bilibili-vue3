...
var getData_1 = __importDefault(require("../utils/getData"));
...
// }
router.get('/carousel', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var carousel;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, getData_1.default)('carousel')];
            case 1:
                carousel = _a.sent();
                res.send(carousel);
                return [2 /*return*/];
